        ...
        child: Column(
          ...
          children: [
            ...
            AppTextField(
              ...
              validator: (v) => ValidationUtils.validateRequired(v, field: 'Name'),
            ),
            ...
            const SizedBox(height: 24),
            AppButton(label: AppText.signUp, onPressed: _submit),
            const SizedBox(height: 16),
            TextButton(
              onPressed: () => context.goAppRoute(AppRoute.signIn),
              child: const Text(AppText.hasAccount),
            ),
          ],
        ),
      ),
